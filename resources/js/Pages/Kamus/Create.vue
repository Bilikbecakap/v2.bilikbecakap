        ...
        <div class="mb-6 md:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Tambahkan kata baru ke dalam kamus Melayu - Indonesia</p>
                </div>
                <Link 
                    href="/kamus" 
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Tambahkan audio pengucapan untuk kata bahasa Melayu</p>
                </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-green-800 dark:text-green-300">
                                        {{ audioFileName || 'Audio rekaman' }}
                                    </p>
                                    <p class="text-xs text-green-600 dark:text-green-400">
                                        Audio siap untuk disimpan
                                    </p>
                                </div>
                            </div>
