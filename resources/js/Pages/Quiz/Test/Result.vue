  ...
  <AdminLayout>
    ...
    >
      ...
      <div class="absolute top-0 left-0 w-full h-full opacity-10">
        <div
          class="absolute top-4 left-4 w-16 h-16 bg-white rounded-full animate-pulse"
        ></div>
        <div
          class="absolute bottom-4 right-4 w-20 h-20 bg-white rounded-full animate-pulse delay-75"
        ></div>
        <div
          class="absolute top-1/2 left-1/4 w-12 h-12 bg-white rounded-full animate-pulse delay-150"
        ></div>
      </div>
          ...
          <div class="p-6">
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <div
                  class="w-12 h-12 mx-auto mb-2 rounded-full bg-green-500 flex items-center justify-center"
                >
                  <svg
              ...
              <div class="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                <div
                  class="w-12 h-12 mx-auto mb-2 rounded-full bg-red-500 flex items-center justify-center"
                >
                  <svg
                    class="w-6 h-6 text-white"
                    fill="none"
              ...
              <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <div
                  class="w-12 h-12 mx-auto mb-2 rounded-full bg-blue-500 flex items-center justify-center"
                >
                  <svg
                    class="w-6 h-6 text-white"
                    fill="none"
              ...
              <div class="ml-11 space-y-2">
                ...
                >
                  ...
                  <span
                    :class="[
                      'flex-1',
                      option.id === answer.selected_option.id ? 'font-medium' : '',
