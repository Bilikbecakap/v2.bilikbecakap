...
const submit = () => {
  form.post(route("data-master.artikel.store"), {
    onSuccess: () => {
      // Handle success
    },
  });
...
<template>
  <Head title="Tambah Master Artikel" />

  <AdminLayout>
    <template #title>Tambah Master Artikel</template>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Buat kategori artikel baru untuk sistem
          </p>
        </div>
