...
const confirmDelete = () => {
  if (selectedArtikel.value) {
    router.delete(route("data-master.artikel.destroy", selectedArtikel.value.id), {
      onSuccess: () => {
...
<template>
  <Head title="Master Artikel" />

  <AdminLayout>
    <template #title>Master Artikel</template>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Kelola kategori artikel untuk sistem
          </p>
        </div>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end gap-2">
                  <Link
                    ...
                    :href="route('data-master.artikel.edit', item.id)"
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-slate-500 dark:text-slate-400">
                  ...
                  <strong>{{ selectedArtikel?.nama_kategori }}</strong
