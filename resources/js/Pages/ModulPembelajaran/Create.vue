...
const submit = () => {
  form.post(route("modul-pembelajaran.store"));
};
...
<template>
  <Head title="Buat Modul Pembelajaran" />

  <AdminLayout>
    <template #title>Buat Modul Pembelajaran</template>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Buat modul pembelajaran dengan konten interaktif dan media pendukung
          </p>
        </div>
        <Link
          ...
          <div class="grid gap-4">
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                URL slug akan dibuat otomatis dari judul modul
              </p>
        ...
        <div class="p-6 space-y-6">
          ...
          <div>
            ...
            <div class="flex gap-4">
              ...
              <div v-if="pdfPreview" class="flex items-center gap-2">
                <div class="flex items-center px-3 py-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                  ...
                  <span class="text-sm text-red-700 dark:text-red-300 truncate max-w-32">{{ pdfPreview }}</span>
                </div>
                <button
                  @click="removePdf"
                  type="button"
