      ...
      <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <div class="space-y-1">
            ...
            <!-- Menu Kuis -->
            <Link v-if="can('view quiz')" href="/admin/quiz" @click="isMobile ? toggleSidebar() : null" :class="[
              'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
              ($page.url === '/admin/quiz' ||
            ...
            <!-- Menu Test Quiz -->
            <Link v-if="can('view test quiz')" href="/admin/quiz-test" @click="isMobile ? toggleSidebar() : null"
              :class="[
                'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
            ...
            <Link v-if="can('view modul pembelajaran')" href="/admin/modul-pembelajaran"
            ...
            <!-- Menu Galeri -->
            <Link v-if="can('view galeri')" href="/admin/galeri" @click="isMobile ? toggleSidebar() : null" :class="[
              'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
            ...
            <!-- Menu Feedback Terjemahan -->
            <Link href="/admin/feedback-terjemahan" @click="isMobile ? toggleSidebar() : null" :class="[
              'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
              $page.url.startsWith('/admin/feedback-terjemahan')
                ? 'bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-700 dark:text-blue-400 border-blue-100 dark:border-blue-800'
                : 'text-slate-600 dark:text-slate-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 hover:text-blue-700 dark:hover:text-blue-400 border-transparent hover:border-blue-100 dark:hover:border-blue-800',
            ]" :title="!sidebarExpanded ? 'Feedback Terjemahan' : ''">
            <font-awesome-icon icon="language" class="w-5 h-5 mr-3 flex-shrink-0" />
            <span v-if="sidebarExpanded">Feedback Terjemahan</span>
            </Link>

            <!-- Menu Komentar -->
            <Link v-if="can('view komentar')" href="/admin/komentar" @click="isMobile ? toggleSidebar() : null" :class="[
              'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
            ...
            <Link
              v-if="can('view dataset')"
              href="/admin/dataset-translate"
              @click="isMobile ? toggleSidebar() : null"
              :class="[
                'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
                $page.url.startsWith('/admin/dataset-translate')
                  ? 'bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-700 dark:text-blue-400 border-blue-100 dark:border-blue-800'
                  : 'text-slate-600 dark:text-slate-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 hover:text-blue-700 dark:hover:text-blue-400 border-transparent hover:border-blue-100 dark:hover:border-blue-800'
              ]"
          ...
          <div class="pt-6">
            ...
            <div class="space-y-1">
              <Link v-if="can('view users')" href="/users" @click="isMobile ? toggleSidebar() : null" :class="[
                'group flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 border',
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="relative language-dropdown-container">
              <button @click="toggleLanguageDropdown"
                ...
                <font-awesome-icon icon="chevron-down" class="w-3 h-3 text-slate-500 dark:text-slate-400" />
              </button>
              ...
              <div v-if="showLanguageDropdown"
                ...
                <button v-for="(lang, code) in languages" :key="code" @click="switchLanguage(code)" :class="[
            ...
            <div class="relative user-dropdown-container">
              <button @click="toggleUserDropdown"
                ...
                <span class="text-sm font-medium text-slate-700 dark:text-slate-200 hidden md:inline">{{ user.name
                }}</span>
                <font-awesome-icon icon="chevron-down" class="w-3 h-3 text-slate-500 dark:text-slate-400" />
              </button>
