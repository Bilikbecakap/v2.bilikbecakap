    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        <div class="p-6">
          ...
          <div class="mb-4">
            <h3
              class="text-lg font-semibold text-slate-800 dark:text-white mb-2 flex items-center"
            >
              {{ menu.title }}
              <span
                v-if="menu.disabled"
                class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-400"
              >
                Coming Soon
              </span>
            </h3>
