  ...
  try {
    ...
    const response = await fetch(route("translate.process"), {
      ...
      body: JSON.stringify({
        ...
        method: "rule_based", //hybrid or rule_based
      }),
    });
      ...
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow">
        ...
        <div class="p-6">
          ...
          <div v-show="activeTab === 'melayu'" class="space-y-4">
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                <label class="block text-sm font-medium">Konten Melayu</label>
                <button
          ...
          <div v-show="activeTab === 'english'" class="space-y-4">
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                <label class="block text-sm font-medium">English Content</label>
                <button
